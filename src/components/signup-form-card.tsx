...
export function SignupFormCard({ className, ...props }: SignupFormCardProps) {
  ...
  const handleFormSubmit = async (data: SignupFormData) => {
    ...
    const { error, data: created } = await authClient.signUp.email({
      email: data.email,
        ...
        {isSuccess ? (
          <div className="flex flex-col items-center justify-center gap-6 p-6 md:p-8">
            <div className="relative">
              <svg className="h-20 w-20 -rotate-90" viewBox="0 0 36 36">
                ...
                <circle
                  ...
                  r="16"
                  fill="none"
                  className="stroke-green-500 transition-all duration-1000 ease-linear"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeDasharray={100.53}
                  strokeDashoffset={100.53 * (countdown / REDIRECT_DELAY)}
                />
              </svg>
            ...
            <div className="flex flex-col items-center gap-2 text-center">
              <h2 className="text-xl font-display">Account created!</h2>
              <p className="text-sm text-muted-foreground max-w-70">
                Your account is subject to verification and approval.
              </p>
            </div>
            ...
            <FieldGroup>
              ...
              <Field className="grid grid-cols-3 gap-4">
                <Button
                  ...
                  type="button"
                  disabled
                  className="disabled:opacity-50 disabled:cursor-not-allowed disabled:border-muted-foreground/20"
                >
